...
alias clearFontCache=" atsutil databases -removeUser "
...
##
## aegise custom aliases
#   ------------------------------------------------------------
alias clamshell0='sudo pmset -b disablesleep 0'
alias clamshell1='sudo pmset -b disablesleep 1'
alias cdworkspace='cd /Volumes/workspace'
alias cddevelopment='cd /Volumes/development'
alias cddocument='cd /Volumes/document'
